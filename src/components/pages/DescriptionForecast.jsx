...
<div style={{display:'flex', flexWrap:'wrap', gap:'50px', justifyContent:'space-around', alignItems:'center'}}>{dayForecast?.map(forecast => <DayForecast forecast={forecast}/>)}</div>
    </div>
  )
}
